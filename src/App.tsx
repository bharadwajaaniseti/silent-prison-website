...
function App() {
  ...
  return (
    <AuthProvider>
      ...
      <div className="relative min-h-screen font-inter text-gray-100">
        <Navigation 
        ...
        {/* Main Content - Make backgrounds transparent */}
        <div className="min-h-screen">
          {renderCurrentSection()}
        </div>

        {/* Mouse Particles - Above content */}
        <div className="fixed inset-0 pointer-events-none" style={{ zIndex: 100 }}>
          <MouseParticles />
        </div>

        {/* Modal - Topmost */}
        <div className="relative" style={{ zIndex: 110 }}>
          <AuthModal 
