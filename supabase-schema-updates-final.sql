...
-- FINAL VERSION - COMPATIBLE WITH EXISTING CODEBASE
-- =====================================================
...
CREATE TABLE IF NOT EXISTS places (
    ...
    position JSONB NOT NULL, -- {x: number, y: number} - pixel offsets from region center
...
BEGIN
    ...
    LOOP
        BEGIN
            ...
            -- Insert the place
            INSERT INTO places (
                id, region_id, name, type, position, size,
